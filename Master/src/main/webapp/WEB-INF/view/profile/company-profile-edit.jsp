                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="breadcrumb-title text-center mb-50">
                            ...
                            <h2 class="big-title"> <strong>Update</strong> Company Profile</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-item">
                            ...
                            <textarea id="companyDescription" name="companyDescription">${user.companyDescription}</textarea>
                        </div>
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-item">
                            <label for="profilePhoto">Update Profile Photo / Company Logo</label>
